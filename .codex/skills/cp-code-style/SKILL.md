...
- Keep lambda and function declaration/definition parameter lists on one line. Do not split formal parameter lists across multiple lines; this does not apply to function calls, initializer lists, or object construction.
